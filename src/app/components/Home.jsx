...
import { FaFileDownload, FaRocketchat } from "react-icons/fa";

function Home() {
  const constraintsRef = useRef(null);

  const kRef = useRef(null);
  const [kPosition, setKPosition] = useState({ top: "30%", left: "29%" });
  ...
  return (
    ...
    >
      ...
      <div className="h-fit w-full flex flex-col items-center justify-center overflow-hidden rounded-md overflow-x-hidden">
        <h1
          className="md:text-8xl text-6xl text-white/80 text-center bg-clip-text font-bold cursor-default"
          ref={kRef}
        >
          Ketan Kumavat
        </h1>
        <h2 className="text-2xl md:text-4xl text-center text-white/70 md:leading-10 leading-9 cursor-default">
          ...
          <div className="flex items-center justify-center mt-20">
            <a href="/KetanKumavat_Resume.pdf" download>
              <button className="button">
                ...
                <div className="text_button flex gap-4 justify-center items-center rounded-sm">
                  <FaFileDownload size={20} fill="white" />
            ...
            <div className="flex">
              <a
                href="#contact"
                className="contact-button flex justify-center items-center gap-4"
              >
                Contact Me
      ...
      <div className="flex mt-8 flex-row gap-5 md:mr-0 mr-0 justify-center items-center">
        <div>
