  ...
  return (
    <motion.div
      ...
      <div className="h-fit w-full flex flex-col items-center justify-center overflow-hidden rounded-md overflow-x-hidden">
        <h1 className="md:text-8xl text-6xl text-white/80 text-center bg-clip-text font-bold cursor-default">
          Ketan Kumavat
        </h1>
          ...
          <div className="flex flex-col md:flex-row items-center justify-center mt-20 md:mt-20 gap-4 md:gap-14 space-y-8 md:space-y-0 -z-40">
            <a href="/KetanKumavat_Resume.pdf" download>
              <button className="button">
                ...
                <div className="text_button flex gap-4 justify-center items-center">
